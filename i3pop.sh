...
sudo apt install i3 dmenu lxappearance ubuntu-restricted-extras snapd pcmanfm thunar feh pavucontrol xcompmgr geany unzip fonts-font-awesome rofi gsimplecal curl sxhkd wget lxtask lxpolkit vlc lxterminal vim i3blocks gparted flatpak i3lock-fancy python3-pip fonts-powerline fonts-noto moc -yy
